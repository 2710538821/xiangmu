<template>
  <div class="container">
    <el-card class="box-card">
      ...
      <el-form label-width="80px" :model="formData">
        <el-row class="top">
            ...
            <el-input placeholder="请输入" v-model="formData.tags"></el-input>
          </el-form-item>
          ...
          <el-form-item label="状态:">
            <el-select placeholder="请选择" v-model="formData.states">
        ...
        <el-table class="table" :data="companysList" style="width: 100%">
          ...
          <el-table-column label="操作" width="180px">
            <template v-slot="{row}">
              ...
              <el-button @click="disableBtn(row)" type="success" icon="el-icon-check" plain circle></el-button>
    ...
    <CompanysAdd :dialogVisible.sync="dialogVisible" @update-data="getCompanysList"/>
  </div>
</template>
